...
class NarratorEngine:
    ...
    _NARRATOR_RULES = {
        "en": (
            ...
            "- Scenes close on their last concrete beat. Never end on a portable maxim, and never personify the setting, the world, or fate as something that waits, watches, judges, or promises.\n"
        ...
        "pt-br": (
            ...
            "- Cenas fecham na sua última batida concreta. Nunca encerre em máxima portátil, e nunca personifique o cenário, o mundo ou o destino como algo que espera, observa, julga ou promete.\n"
